...
<div class="container bg-dark rounded-4 my-5 col-4 mx-auto">
    <h4 class="text-center text-danger text-uppercase py-2">product create panel</h4>
</div>
<div class="col-8 container bg-dark rounded-5 py-5 px-5 mt-5">
    ...
    <?php endif; ?>
    <form action="<?php echo finalRoot?>/products/store" method="post" enctype="multipart/form-data">
    ...
    <div class="text-center mt-4"><a style="background-color: #CC1616" class="btn text-capitalize text-white" href="<?php echo finalRoot?>/Products/details">Product details</a></div>
</div>
<?php
