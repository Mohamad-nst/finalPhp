...
<div class="container bg-dark rounded-4 my-5 col-4 mx-auto">
    <h4 class="text-center text-danger text-uppercase py-2">details title panel</h4>
</div>
<div class="container col-10 rounded-5 mx-auto px-2 py-2 bg-dark mt-5">
    ...
    <table class="table table-dark">
        ...
        <?php foreach ($data['title'] as $item): ?>
            <tr>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo $item->id?></td>
                <td style="line-height: 115px;font-size: 25px" class="text-capitalize text-center"><?php echo $item->title ?></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo substr($item->description,0,20)?></td>
                ...
                <td style="line-height: 115px" class="text-center">
                    <form action="<?php echo finalRoot?>/Titles/delete" method="post">
                        <input type="hidden" name="id" value="<?php echo $item->id ?>">
                        <input type="submit" class="btn btn-danger text-white text-capitalize" value="delete">
                    </form>
                </td>
                <td style="line-height: 115px" class="text-center">
                    <form action="<?php echo finalRoot?>/Titles/edit" method="post">
                        <input type="hidden" name="id" value="<?php echo $item->id ?>">
    ...
    <div class="text-center my-4"><a class="btn btn-info text-capitalize text-white" href="<?php echo finalRoot?>/Titles/create">Question create</a>
    </div>
</div>
<?php
