...
<div class="container bg-dark rounded-4 my-5 col-4 mx-auto">
    <h4 class="text-center text-danger text-uppercase py-2">details team panel</h4>
</div>
<div class="container col-10 rounded-5 mx-auto px-2 py-2 bg-dark my-5">
    ...
    <table class="table table-dark">
        <tr>
            ...
            <td class="text-white text-capitalize text-center">fullName</td>
            <td class="text-white text-capitalize text-center">job</td>
            <td class="text-white text-capitalize text-center">description</td>
            <td class="text-white text-capitalize text-center">social</td>
        ...
        <?php foreach ($data['team'] as $item): ?>
            <tr>
                ...
                <td style="line-height: 115px" class="text-capitalize text-center"><img style="width: 100px;height: 100px;object-fit: cover;border-radius: 50%" src="<?php echo showImage('Team',$item)?>"></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo $item->alt?></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo $item->fullName?></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo $item->job?></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo substr($item->description,0,25)?></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><i class="<?php echo $item->class ?>"></i></td>
                ...
                <td style="line-height: 115px" class="text-center">
                    <form action="<?php echo finalRoot?>/Teams/delete" method="post">
                        <input type="hidden" name="id" value="<?php echo $item->id ?>">
                        <input type="submit" class="btn btn-danger text-white text-capitalize" value="delete">
                    </form>
                </td>
                <td style="line-height: 115px" class="text-center">
                    <form action="<?php echo finalRoot?>/Teams/edit" method="post">
                        <input type="hidden" name="id" value="<?php echo $item->id ?>">
    ...
    <div class="text-center my-4"><a class="btn btn-info text-capitalize text-white" href="<?php echo finalRoot?>/Teams/create">team create</a>
    </div>
</div>
<?php
