...
<div class="container bg-dark rounded-4 my-5 col-4 mx-auto">
    <h4 class="text-center text-danger text-uppercase py-2">details service panel</h4>
</div>
<div class="container col-10 rounded-5 mx-auto px-2 py-2 bg-dark mt-5">
    ...
    <table class="table table-dark">
        <tr>
            ...
            <td class="text-white text-capitalize text-center">icon</td>
        ...
        <?php foreach ($data['service'] as $item): ?>
            <tr>
                ...
                <td style="line-height: 115px;font-size: 25px" class="text-capitalize text-center <?php echo $item->color ?>"><i class="<?php echo $item->class?>"></i></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo $item->title?></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo substr($item->description,0,50)?></td>
                ...
                <td style="line-height: 115px" class="text-center">
                    <form action="<?php echo finalRoot?>/Services/delete" method="post">
                        <input type="hidden" name="id" value="<?php echo $item->id ?>">
                        <input type="submit" class="btn btn-danger text-white text-capitalize" value="delete">
                    </form>
                </td>
                <td style="line-height: 115px" class="text-center">
                    <form action="<?php echo finalRoot?>/Services/edit" method="post">
                        <input type="hidden" name="id" value="<?php echo $item->id ?>">
    ...
    <div class="text-center my-4"><a class="btn btn-info text-capitalize text-white" href="<?php echo finalRoot?>/Services/create">Slider create</a>
    </div>
</div>
<?php
