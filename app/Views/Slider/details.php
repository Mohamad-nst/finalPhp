...
<div class="container bg-dark rounded-4 my-5 col-4 mx-auto">
    <h4 class="text-center text-danger text-uppercase py-2">details slider panel</h4>
</div>
<div class="container col-10 rounded-5 mx-auto px-2 py-2 bg-dark mt-5">
    ...
    <table class="table table-dark">
        ...
        <?php foreach ($data['slider'] as $item): ?>
            <tr>
                ...
                <td style="line-height: 115px" class="text-capitalize text-center"><img style="width: 100px;height: 100px;object-fit: cover;border-radius: 50%" src="<?php echo showImage('slider',$item)?>"></td>
                <td style="line-height: 115px" class="text-capitalize text-center"><?php echo $item->alt?></td>
                <td style="line-height: 115px" class="text-capitalize text-center">
                    <?php if (intval($item->publish)===1): ?>
                        <span class="btn btn-success text-capitalize">active</span>
                    <?php else: ?>
                        <span class="btn btn-danger text-capitalize">DeActive</span>
                    <?php endif; ?>
                </td>
                ...
                <td style="line-height: 115px" class="text-center">
                    <form action="<?php echo finalRoot?>/Sliders/delete" method="post">
                        <input type="hidden" name="id" value="<?php echo $item->id ?>">
                        <input type="submit" class="btn btn-danger text-white text-capitalize" value="delete">
                    </form>
                </td>
                <td style="line-height: 115px" class="text-center">
                    <form action="<?php echo finalRoot?>/Sliders/edit" method="post">
                        <input type="hidden" name="id" value="<?php echo $item->id ?>">
    ...
    <div class="text-center my-4"><a class="btn btn-info text-capitalize text-white" href="<?php echo finalRoot?>/Sliders/create">Slider create</a>
    </div>
</div>
<?php
