...
<div class="container bg-dark rounded-4 my-5 col-4  mx-auto">
    <h4 class="text-center text-danger text-uppercase py-2">category edit panel</h4>
</div>
<div class="col-8 container bg-dark rounded-5 p-5 mt-5">
    <img style="width: 150px;height:150px;object-fit: cover;border-radius: 50%;display: block;margin:0 auto" src="<?php echo finalRoot?>/public/images/Category/<?php echo $data['image'] ?>" >
    <form action="<?php echo finalRoot?>/Categories/update" method="post" enctype="multipart/form-data">
        ...
        <div class="text-center"><input type="submit" class="btn btn-success text-capitalize mt-5" value="edit">
        </div>
    </form>
    <div class="text-center my-4"><a style="background-color: #CC1616" class="btn text-capitalize text-white" href="<?php echo finalRoot?>/Categories/details">Category details</a>
    </div>
</div>
<!-- end edit -->
<!-- start footer -->
